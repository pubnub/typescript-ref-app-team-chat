...
import NetworkStatus from "features/currentUser/MyUserDetails/NetworkStatus";
import { Wrapper, Avatar, About, UserName, UserTitle } from "./style";
...
const MyUserDetails = () => {
  ...
  return (
    <Wrapper>
      <Avatar>
        <NetworkStatus />
        <UserInitialsAvatar size={56} name={user.name} uuid={user.name} />
      </Avatar>
      <About>
